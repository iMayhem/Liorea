  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        head_row: "flex mb-2",
        head_cell: "text-white/40 rounded-md w-8 font-medium text-[0.8rem] uppercase tracking-wide hidden",
        ...
        day: cn(
          "h-8 w-8 p-0 font-normal text-white aria-selected:opacity-100 hover:bg-white/10 rounded-full transition-all duration-200 hidden"
        ),
