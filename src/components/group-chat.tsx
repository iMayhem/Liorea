...
import { Send, MessageSquare, CornerDownLeft, X, Image as ImageIcon, ShieldCheck } from 'lucide-react';
          ...
          <div className="pr-4 space-y-4">
            {messages.map((msg) => {
                ...
                >
                    ...
                    >
                        <p className={cn("text-xs font-semibold mb-0.5", senderIsMod ? "text-red-400" : "text-muted-foreground/80")}>
                            {senderIsMod && <ShieldCheck className="inline-block h-3 w-3 mr-1" />}
