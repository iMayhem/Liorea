...
export const api = {
    ...
    chat: {
        ...
        send: (data: { room_id: string, username: string, message: string, photoURL: string, image_url?: string, replyTo?: any }) => request('/chat/send', { method: 'POST', body: JSON.stringify(data) }),
