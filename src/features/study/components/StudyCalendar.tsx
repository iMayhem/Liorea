...
import { BentoCard, CardContent, CardHeader } from "@/components/ui/BentoCard"
...
export default function StudyCalendar() {
  ...
  return (
    ...
    <BentoCard className="w-full max-w-xs mx-auto border border-zinc-800 shadow-sm bg-[#18181b] text-white">
