...
import { usePresence } from '@/shared/context/PresenceContext'; // Import Context
...
export default function AuthForm({ onLogin }: AuthFormProps) {
    ...
    return (
        <div className="flex items-center justify-center w-full min-h-screen px-4">
            <Card className="w-full max-w-[400px] bg-black/40 backdrop-blur-xl border border-white/10 text-white shadow-2xl transition-all duration-300">
